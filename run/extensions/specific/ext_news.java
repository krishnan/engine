 ...
 * Created: 2014-12-07T00:21:33Z
 * LicenseName: EUPL-1.1-without-appendix
 * FileName: news.java  
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> news file type. </text> 
 */
 ...
 */
public class ext_news extends FileExtension{
    /**
    ...
    public String getDescription() {
        return "Document with the news related to a project"; // file type description
    }
