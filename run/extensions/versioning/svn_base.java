 ...
 * Created: 2014-12-08T00:36:09Z
 * LicenseName: EUPL-1.1-without-appendix
 * FileName: svn-base.java  
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> svn-base file type. </text> 
 */
 ...
 */
public class svn_base extends FileExtension{
    /**
    ...
    public String getDescription() {
        return "A file backup inside the SVN repository"; // file type description
    }
    ...
    public ContentType getContentType() {
        // strangely enough, I only notice this extension applied to text files
