 ...
 * Created: 2014-12-06T21:12:04Z
 * LicenseName: EUPL-1.1-without-appendix
 * FileName: tgz_archive.java  
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> tgz_archive file type. </text> 
 */
 ...
 */
public class tgz extends FileExtension{
    /**
    ...
    public String getDescription() {
        return "Tar-GZipped archive file"; // file type description
    }
