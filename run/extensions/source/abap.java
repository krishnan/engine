 ...
 * use of the "abap" extension. When possible, the file provenance author
 ...
 */
public class abap extends FileExtension{
    /**
    ...
    public String getDescription() {
        return "ABAP script"; // file type description
    }
    ...
    public FileLanguage getLanguage(){
        return FileLanguage.ABAP; // to which language is the file more related?
    }
