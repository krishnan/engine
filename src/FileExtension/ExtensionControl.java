...
public final class ExtensionControl {
    ...
    public void addExtensionsInMemory() {
        // clear up the list to avoid duplicates
        list.clear();
        listIndexes.clear();
        
        // get the list that we generated by machine in advance
        ExtensionList ext = new ExtensionList();
        // transfer the list
        list.addAll(ext.getList());
        // generate an index for fast access
        for(FileExtension extension : list){
            listIndexes.add(extension.getIdentifierShort());
        }
