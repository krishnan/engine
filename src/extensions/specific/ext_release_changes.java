 ...
 * Created: 2014-12-06T23:52:36Z
 * LicenseName: AGPL-3.0+
 * FileName: release_changes.java  
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> release_changes file type. </text> 
 */
 ...
 */
public class ext_release_changes extends FileExtension{
    /**
    ...
    public String getDescription() {
        return "Document with release notes"; // file type description
    }
