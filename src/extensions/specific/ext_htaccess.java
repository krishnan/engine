 ...
 * Created: 2014-12-02T23:42:22Z
 * LicenseName: EUPL-1.1-without-appendix
 * FileName: htaccess.java  
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> "htaccess" file type. </text> 
 */
 ...
 */
public class ext_htaccess extends FileExtension{
    /**
    ...
    public String getDescription() {
        return "Apache server configuration file"; // file type description
    }
