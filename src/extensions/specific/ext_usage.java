 ...
 * Created: 2014-12-06T20:23:16Z
 * LicenseName: EUPL-1.1-without-appendix
 * FileName: usage.java  
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> usage file type. </text> 
 */
 ...
 */
public class ext_usage extends FileExtension{
    /**
    ...
    public String getDescription() {
        return "Document explaining how to use a project"; // file type description
    }
