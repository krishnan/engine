 ...
 * Created: 2014-12-02T23:39:40Z
 * LicenseName: EUPL-1.1-without-appendix
 * FileName: credits.java  
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> credits file type. </text> 
 */
...
public class ext_credits extends FileExtension{
    ...
    public String getDescription() {
        return "Document detailing the people/groups involved in a given project"; // file type description
    }
