 ...
 * Created: 2014-12-06T23:36:39Z
 * LicenseName: AGPL-3.0+
 * FileName: latest.java  
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> latest file type. </text> 
 */
 ...
 */
public class ext_latest extends FileExtension{
    /**
    ...
    public String getDescription() {
        return "Document describing the latest changes on a project"; // file type description
    }
