 ...
 * Created: 2014-12-07T00:21:37Z
 * LicenseName: AGPL-3.0+
 * FileName: announce.java  
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> announce file type. </text> 
 */
 ...
 */
public class ext_announce extends FileExtension{
    /**
    ...
    public String getDescription() {
        return "Document announcing details of a project (authors, install, docs, ..)"; // file type description
    }
