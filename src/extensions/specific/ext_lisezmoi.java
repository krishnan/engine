 ...
 * Created: 2014-12-06T22:21:51Z
 * LicenseName: AGPL-3.0+
 * FileName: lisezmoi.java  
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> lisezmoi file type. </text> 
 */
 ...
 */
public class ext_lisezmoi extends FileExtension{
    /**
    ...
    public String getDescription() {
        return "Read-Me document in French language"; // file type description
    }
