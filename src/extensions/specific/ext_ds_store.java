 ...
 * Created: 2014-12-07T00:32:46Z
 * LicenseName: AGPL-3.0+
 * FileName: ds_store.java  
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> 
    Stores viewing preferences for a folder in Mac OS X; includes information
    about the folder's window location, window size, what view option has been
    selected (icon, list, or column), and the layout of icons in the window.

    Retrieved from http://www.fileinfo.com/extension/ds_store
    </text> 
 */
 ...
 */
public class ext_ds_store extends FileExtension{
    /**
    ...
    public String getDescription() {
        return "File with viewing preferences for a folder in MacOSX"; // file type description
    }
