 ...
 * Created: 2014-12-03T00:43:12Z
 * LicenseName: AGPL-3.0+
 * FileName: markdown.java  
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> markdown file type. </text> 
 */
 ...
 */
public class markdown extends FileExtension{
    /**
    ...
    public String getDescription() {
        return "Document formatted with MarkDown syntax"; // file type description
    }
