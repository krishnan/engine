 ...
 * Created: 2014-12-07T22:54:43Z
 * LicenseName: EUPL-1.1-without-appendix
 * FileName: mdb.java  
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> mdb file type. </text> 
 */
 ...
 */
public class mdb extends FileExtension{
    /**
    ...
    public String getDescription() {
        return "Microsoft Access database file"; // file type description
    }
