 ...
 * FileComment: <text> The R programming language. </text> 
 */
 ...
 */
public class r extends FileExtension{
    /**
    ...
    public String getDescription() {
        return "R source code file"; // file type description
    }
    ...
    public FileLanguage getLanguage(){
        return FileLanguage.R; // to which language is the file more related?
    }
