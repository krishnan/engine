package extensions.source.cpp_lang;
 ...
 * Created: 2014-12-06T18:02:49Z
 * LicenseName: EUPL-1.1-without-appendix
 * FileName: pch.java  
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> pch file type. </text> 
 */
 ...
 */
public class ext_pch extends FileExtension{
    /**
    ...
    public String getDescription() {
        return "Pre-Compiled Header source code file"; // file type description
    }
    ...
    public FileLanguage getLanguage(){
        ...
        languages.add(FileLanguage.C_SHARP);
