package extensions.source.csharp;
 ...
 * Created: 2014-12-03T00:54:38Z
 * LicenseName: EUPL-1.1-without-appendix
 * FileName: userprefs.java  
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> userprefs file type. </text> 
 */
 ...
 */
public class userprefs extends FileExtension{
    /**
    ...
    public String getDescription() {
        return "Visual Studio configuration document"; // file type description
    }
