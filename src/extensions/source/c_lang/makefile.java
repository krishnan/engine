 ...
 * Created: 2014-12-06T18:06:42Z
 * LicenseName: AGPL-3.0+
 * FileName: makefile.java  
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> makefile file type. </text> 
 */
 ...
 */
public class makefile extends FileExtension{
    /**
    ...
    public String getDescription() {
        return "GCC script file"; // file type description
    }
