package extensions.source.c_lang;
 ...
 * FileComment: <text> C language dedicated to Arduino control. </text> 
 */
 ...
 */
public class ino extends FileExtension{
    /**
    ...
    public String getDescription() {
        return "C source code file for Arduino"; // file type description
    }
