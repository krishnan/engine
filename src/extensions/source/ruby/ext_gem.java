 ...
 * Created: 2014-12-06T18:44:06Z
 * LicenseName: EUPL-1.1-without-appendix
 * FileName: gem.java  
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> gem file type. </text> 
 */
 ...
 */
public class ext_gem extends FileExtension{
    /**
    ...
    public String getDescription() {
        return "Ruby Gem metadata source code file"; // file type description
    }
