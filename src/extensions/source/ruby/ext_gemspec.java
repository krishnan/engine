 ...
 * Created: 2014-12-02T23:39:35Z
 * LicenseName: EUPL-1.1-without-appendix
 * FileName: gemspec.java  
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> "gemspec" file type. </text> 
 */
 ...
 */
public class ext_gemspec extends FileExtension{
    /**
    ...
    public String getDescription() {
        return "A document listing Ruby dependencies"; // file type description
    }
