package extensions.source.matlab;
 ...
 * FileComment: <text> The MatLab programming language. </text> 
 */
 ...
 */
public class mat extends FileExtension{
    /**
    ...
    public String getDescription() {
        return "MatLab binary code file"; // file type description
    }
    ...
    public FileLanguage getLanguage(){
        return FileLanguage.MATLAB; // to which language is the file more related?
    }
