 ...
 * FileComment: <text> The D programming language. </text> 
 */
 ...
 */
public class d extends FileExtension{
    /**
    ...
    public String getDescription() {
        return "D source code file"; // file type description
    }
    ...
    public FileLanguage getLanguage(){
        return FileLanguage.D; // to which language is the file more related?
    }
