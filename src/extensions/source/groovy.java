 ...
 * FileName: groovy.java  
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> The Groovy scripting language. </text> 
 */
 ...
 */
public class groovy extends FileExtension{
    /**
    ...
    public String getDescription() {
        return "Groovy script file"; // file type description
    }
    ...
    public FileLanguage getLanguage(){
        return FileLanguage.GROOVY; // to which language is the file more related?
    }
