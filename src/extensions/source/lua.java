 ...
 * FileComment: <text> The Lua programming language. </text> 
 */
...
public class lua extends FileExtension{
    ...
    public String getDescription() {
        return "Lua source code file"; // file type description
    }
    ...
    public FileLanguage getLanguage(){
        return FileLanguage.LUA; // to which language is the file more related?
    }
