 ...
 */
public class clojure extends FileExtension{
    /**
    ...
    public String getDescription() {
        return "Clojure source code file"; // file type description
    }
    ...
    public FileLanguage getLanguage(){
        return FileLanguage.CLOJURE; // to which language is the file more related?
    }
