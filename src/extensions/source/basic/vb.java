package extensions.source.basic;
 ...
 * Created: 2014-12-08T13:20:55Z
 * LicenseName: EUPL-1.1-without-appendix
 * FileName: vb.java  
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> vb file type. </text> 
 */
 ...
 */
public class vb extends FileExtension{
    /**
    ...
    public String getDescription() {
        return "Visual Basic source code file"; // file type description
    }
