 ...
 * Created: 2014-12-03T00:41:21Z
 * LicenseName: EUPL-1.1-without-appendix
 * FileName: scala.java  
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> scala programming language. </text> 
 */
 ...
 */
public class scala extends FileExtension{
    /**
    ...
    public String getDescription() {
        return "Scale source code file"; // file type description
    }
    ...
    public FileLanguage getLanguage(){
        return FileLanguage.SCALA; // to which language is the file more related?
    }
