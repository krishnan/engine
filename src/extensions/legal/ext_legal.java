 ...
 * Created: 2014-12-08T01:01:18Z
 * LicenseName: AGPL-3.0+
 * FileName: leg.java  
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> leg file type. </text> 
 */
 ...
 */
public class ext_legal extends FileExtension{
    /**
    ...
    public String getDescription() {
        return "A text file with legal information about a project"; // file type description
    }
