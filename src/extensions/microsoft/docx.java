 ...
 * FileComment: <text> docx file type. </text> 
 */
 ...
 */
public class docx extends FileExtension{
    /**
    ...
    public String getDescription() {
        return "Microsoft Word document"; // file type description
    }
