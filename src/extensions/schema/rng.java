 ...
 * Created: 2014-12-06T21:47:56Z
 * LicenseName: AGPL-3.0+
 * FileName: rng.java  
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> 
    File used for validating .XML documents; uses a simple schema language for
    XML that focuses on the description and validation of the structure and 
    content of an XML document.
    
    Retrieved from http://www.fileinfo.com/extension/rng
    </text> 
 */
 ...
 */
public class rng extends FileExtension{
    /**
    ...
    public String getDescription() {
        return "RELAX NG schema file"; // file type description
    }
