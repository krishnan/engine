 ...
 * Created: 2014-12-06T18:11:04Z
 * LicenseName: AGPL-3.0+
 * FileName: wsdl.java  
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> wsdl file type. </text> 
 */
 ...
 */
public class wsdl extends FileExtension{
    /**
    ...
    public String getDescription() {
        return "Schema for transmitting online objects/services"; // file type description
    }
