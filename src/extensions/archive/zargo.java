 ...
 * Created: 2014-12-06T20:54:22Z
 * LicenseName: EUPL-1.1-without-appendix
 * FileName: zargo.java  
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> zargo file type. </text> 
 */
 ...
 */
public class zargo extends FileExtension{
    /**
    ...
    public String getDescription() {
        return "Compressed archive"; // file type description
    }
