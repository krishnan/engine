 ...
 * FileComment: <text> Coffee script files </text> 
 */
 ...
 */
public class coffee extends FileExtension{
    /**
    ...
    public String getDescription() {
        return "Coffee script file"; // file type description
    }
    ...
    public FileLanguage getLanguage(){
        return FileLanguage.COFFEE; // to which language is the file more related?
    }
