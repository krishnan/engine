 ...
 * Created: 2014-12-06T18:02:18Z
 * LicenseName: EUPL-1.1-without-appendix
 * FileName: less.java  
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> less file type. </text> 
 */
 ...
 */
public class less extends FileExtension{
    /**
    ...
    public String getDescription() {
        return "Stylesheet language for the LESS CSS processor"; // file type description
    }
