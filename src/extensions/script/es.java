 ...
 * Created: 2014-12-02T21:19:15Z
 * LicenseName: AGPL-3.0+
 * FileName: es.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> ECMAscript (Javascript) source file </text> 
 */
 ...
 */
public class es extends FileExtension{
    /**
    ...
    public String getDescription() {
        return "ECMAScript code file"; // file type description
    }
