 ...
 * use of the "el" extension. When possible, the file provenance author
 ...
 */
public class el extends FileExtension{
    /**
    ...
    public String getDescription() {
        return "Emacs Lisp script file"; // file type description
    }
