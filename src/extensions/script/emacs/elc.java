package extensions.script.emacs;
 ...
 * use of the "elc" extension. When possible, the file provenance author
 ...
 */
public class elc extends FileExtension{
    /**
    ...
    public String getDescription() {
        return "Emacs Lisp byte code file"; // file type description
    }
    ...
    public FileLanguage getLanguage(){
        return FileLanguage.LISP; // to which language is the file more related?
    }
