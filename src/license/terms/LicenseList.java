...
public final class LicenseList {
	...
	list.add(new license.terms.SPDXLL.Abstyles());
	list.add(new license.terms.SPDXLL.Adobe_2006());
	list.add(new license.terms.SPDXLL.Adobe_Glyph());
	list.add(new license.terms.SPDXLL.ADSL());
	list.add(new license.terms.SPDXLL.AFL_1_1());
	list.add(new license.terms.SPDXLL.AFL_1_2());
	list.add(new license.terms.SPDXLL.AFL_2_0());
	list.add(new license.terms.SPDXLL.AFL_2_1());
	list.add(new license.terms.SPDXLL.AFL_3_0());
	list.add(new license.terms.SPDXLL.Afmparse());
	list.add(new license.terms.SPDXLL.AGPL_1_0());
	list.add(new license.terms.SPDXLL.AGPL_3_0());
	list.add(new license.terms.SPDXLL.Aladdin());
	list.add(new license.terms.SPDXLL.AMDPLPA());
	...
	list.add(new license.terms.SPDXLL.APSL_1_0());
	list.add(new license.terms.SPDXLL.APSL_1_1());
	list.add(new license.terms.SPDXLL.APSL_1_2());
	list.add(new license.terms.SPDXLL.APSL_2_0());
	list.add(new license.terms.SPDXLL.Artistic_1_0());
	list.add(new license.terms.SPDXLL.Artistic_1_0_cl8());
	list.add(new license.terms.SPDXLL.Artistic_1_0_Perl());
	list.add(new license.terms.SPDXLL.Artistic_2_0());
	list.add(new license.terms.SPDXLL.Bahyph());
	list.add(new license.terms.SPDXLL.Barr());
	...
	list.add(new license.terms.SPDXLL.BSD_3_Clause_Attribution());
	list.add(new license.terms.SPDXLL.BSD_3_Clause_Clear());
	list.add(new license.terms.SPDXLL.BSD_3_Clause_LBNL());
	list.add(new license.terms.SPDXLL.BSD_4_Clause());
	list.add(new license.terms.SPDXLL.BSD_4_Clause_UC());
	list.add(new license.terms.SPDXLL.BSD_Protection());
	list.add(new license.terms.SPDXLL.BSL_1_0());
	list.add(new license.terms.SPDXLL.bzip2_1_0_5());
	list.add(new license.terms.SPDXLL.bzip2_1_0_6());
	list.add(new license.terms.SPDXLL.Caldera());
	...
	list.add(new license.terms.SPDXLL.CECILL_2_0());
	list.add(new license.terms.SPDXLL.CECILL_B());
	list.add(new license.terms.SPDXLL.CECILL_C());
	list.add(new license.terms.SPDXLL.ClArtistic());
	list.add(new license.terms.SPDXLL.CNRI_Python());
	list.add(new license.terms.SPDXLL.CNRI_Python_GPL_Compatible());
	list.add(new license.terms.SPDXLL.Condor_1_1());
	list.add(new license.terms.SPDXLL.CPAL_1_0());
	list.add(new license.terms.SPDXLL.CPL_1_0());
	list.add(new license.terms.SPDXLL.CPOL_1_02());
	list.add(new license.terms.SPDXLL.Crossword());
	...
	list.add(new license.terms.SPDXLL.D_FSL_1_0());
	list.add(new license.terms.SPDXLL.ECL_1_0());
	list.add(new license.terms.SPDXLL.ECL_2_0());
	list.add(new license.terms.SPDXLL.eCos_2_0());
	list.add(new license.terms.SPDXLL.EFL_1_0());
	list.add(new license.terms.SPDXLL.EFL_2_0());
	list.add(new license.terms.SPDXLL.eGenix());
	list.add(new license.terms.SPDXLL.Entessa());
	list.add(new license.terms.SPDXLL.EPL_1_0());
	list.add(new license.terms.SPDXLL.ErlPL_1_1());
	list.add(new license.terms.SPDXLL.EUDatagrid());
	list.add(new license.terms.SPDXLL.EUPL_1_0());
	...
	list.add(new license.terms.SPDXLL.GPL_3_0_plus());
	list.add(new license.terms.SPDXLL.GPL_3_0_with_autoconf_exception());
	list.add(new license.terms.SPDXLL.GPL_3_0_with_GCC_exception());
	list.add(new license.terms.SPDXLL.gSOAP_1_3b());
	list.add(new license.terms.SPDXLL.HaskellReport());
	list.add(new license.terms.SPDXLL.HPND());
	list.add(new license.terms.SPDXLL.IBM_pibs());
	list.add(new license.terms.SPDXLL.IJG());
	list.add(new license.terms.SPDXLL.ImageMagick());
	list.add(new license.terms.SPDXLL.iMatix());
	list.add(new license.terms.SPDXLL.Imlib2());
	...
	list.add(new license.terms.SPDXLL.MirOS());
	list.add(new license.terms.SPDXLL.MIT());
	list.add(new license.terms.SPDXLL.MITNFA());
	list.add(new license.terms.SPDXLL.MIT_advertising());
	list.add(new license.terms.SPDXLL.MIT_CMU());
	list.add(new license.terms.SPDXLL.MIT_enna());
	list.add(new license.terms.SPDXLL.MIT_feh());
	list.add(new license.terms.SPDXLL.Motosoto());
	list.add(new license.terms.SPDXLL.mpich2());
	list.add(new license.terms.SPDXLL.MPL_1_0());
	list.add(new license.terms.SPDXLL.MPL_1_1());
	list.add(new license.terms.SPDXLL.MPL_2_0());
	...
	list.add(new license.terms.SPDXLL.OGTSL());
	list.add(new license.terms.SPDXLL.OLDAP_1_1());
	list.add(new license.terms.SPDXLL.OLDAP_1_2());
	list.add(new license.terms.SPDXLL.OLDAP_1_3());
	list.add(new license.terms.SPDXLL.OLDAP_1_4());
	list.add(new license.terms.SPDXLL.OLDAP_2_0());
	list.add(new license.terms.SPDXLL.OLDAP_2_0_1());
	list.add(new license.terms.SPDXLL.OLDAP_2_1());
	list.add(new license.terms.SPDXLL.OLDAP_2_2());
	list.add(new license.terms.SPDXLL.OLDAP_2_2_1());
	list.add(new license.terms.SPDXLL.OLDAP_2_2_2());
	list.add(new license.terms.SPDXLL.OLDAP_2_3());
	list.add(new license.terms.SPDXLL.OLDAP_2_4());
	list.add(new license.terms.SPDXLL.OLDAP_2_5());
	...
	list.add(new license.terms.SPDXLL.RSCPL());
	list.add(new license.terms.SPDXLL.Ruby());
	list.add(new license.terms.SPDXLL.Saxpath());
	list.add(new license.terms.SPDXLL.SAX_PD());
	list.add(new license.terms.SPDXLL.SCEA());
	list.add(new license.terms.SPDXLL.SGI_B_1_0());
	list.add(new license.terms.SPDXLL.SGI_B_1_1());
	list.add(new license.terms.SPDXLL.SGI_B_2_0());
	list.add(new license.terms.SPDXLL.SimPL_2_0());
	list.add(new license.terms.SPDXLL.SISSL());
	list.add(new license.terms.SPDXLL.SISSL_1_2());
	list.add(new license.terms.SPDXLL.Sleepycat());
	...
	list.add(new license.terms.SPDXLL.TMate());
	list.add(new license.terms.SPDXLL.TORQUE_1_1());
	list.add(new license.terms.SPDXLL.TOSL());
	list.add(new license.terms.SPDXLL.Unicode_TOU());
	list.add(new license.terms.SPDXLL.Unlicense());
	list.add(new license.terms.SPDXLL.Vim());
	list.add(new license.terms.SPDXLL.VOSTROM());
	list.add(new license.terms.SPDXLL.VSL_1_0());
	list.add(new license.terms.SPDXLL.W3C());
	list.add(new license.terms.SPDXLL.Watcom_1_0());
	list.add(new license.terms.SPDXLL.Wsuipa());
	list.add(new license.terms.SPDXLL.WTFPL());
	list.add(new license.terms.SPDXLL.WXwindows());
	list.add(new license.terms.SPDXLL.X11());
	list.add(new license.terms.SPDXLL.Xerox());
	list.add(new license.terms.SPDXLL.XFree86_1_1());
	list.add(new license.terms.SPDXLL.xinetd());
	list.add(new license.terms.SPDXLL.Xnet());
	list.add(new license.terms.SPDXLL.xpp());
	list.add(new license.terms.SPDXLL.XSkat());
	list.add(new license.terms.SPDXLL.YPL_1_0());
	list.add(new license.terms.SPDXLL.YPL_1_1());
	list.add(new license.terms.SPDXLL.Zed());
	list.add(new license.terms.SPDXLL.Zend_2_0());
	list.add(new license.terms.SPDXLL.Zimbra_1_3());
	list.add(new license.terms.SPDXLL.Zlib());
	list.add(new license.terms.SPDXLL.zlib_acknowledgement());
