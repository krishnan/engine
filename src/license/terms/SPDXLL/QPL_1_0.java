...
public class QPL_1_0 extends License{
   /**
    ...
    public String getTerms(){
        ...
        + "also able to receive the complete machine-readable source code to the distribute"
        + "d Software, including all modifications, without any charge beyond the costs of "
        + "data transfer, and place prominent notices in the distribution explaining this.\n"
        + "\n"
        + "     c. You must ensure that all modifications included in the machine-executabl"
        + "e forms are available under the terms of this license.\n"
        + "\n"
        ...
        + " items are also able to receive and use the complete machine-readable source cod"
        + "e to the items without any charge beyond the costs of data transfer.\n"
        + "\n"
        + "     b. You must explicitly license all recipients of your items to use and re-d"
        + "istribute original and modified versions of the items in both machine-executable"
        + " and source code forms. The recipients must be able to do so without any charges"
        + " whatsoever, and they must be able to re-distribute to anyone they choose.\n"
        + "   \n"
        + "     c. If the items are not available to the general public, and the initial de"
        + "veloper of the Software requests a copy of the items, then you must supply one.\n"
        + "\n"
