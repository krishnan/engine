...
public class LPL_1_02 extends License{
   /**
    ...
    public String getTerms(){
        ...
        + "\"Contribution\" means:\n"
        + "\n"
        + "     a.  in the case of Lucent Technologies Inc. (\"LUCENT\"), the Original Progra"
        + "m, and\n"
        ...
        + "\n"
        + "          where such changes and/or additions to the Program were added to the P"
        + "rogram by such Contributor itself or anyone acting on such Contributor's behalf,"
        + " and the Contributor explicitly consents, in accordance with Section 3C, to char"
        + "acterization of the changes and/or additions as Contributions.\n"
        + "\n"
        ...
        + "Recipient a non-exclusive, worldwide, royalty-free copyright license to reproduc"
        + "e, prepare derivative works of, publicly display, publicly perform, distribute a"
        + "nd sublicense the Contribution of such Contributor, if any, and such derivative "
        + "works, in source code and object code form.\n"
        + "\n"
        + "     b.  Subject to the terms of this Agreement, each Contributor hereby grants "
        + "Recipient a non-exclusive, worldwide, royalty-free patent license under Licensed"
        + " Patents to make, use, sell, offer to sell, import and otherwise transfer the Co"
        + "ntribution of such Contributor, if any, in source code and object code form. The"
        + " patent license granted by a Contributor shall also apply to the combination of "
        + "the Contribution of that Contributor and the Program if, at the time the Contrib"
        + "ution is added by the Contributor, such addition of the Contribution causes such"
        + " combination to be covered by the Licensed Patents. The patent license granted b"
        + "y a Contributor shall not apply to (i) any other combinations which include the "
        + "Contribution, nor to (ii) Contributions of other Contributors. No hardware per s"
        + "e is licensed hereunder.\n"
        + "\n"
        ...
        + " the Program:\n"
        + "\n"
        + "     Copyright (C) 2003, Lucent Technologies Inc. and others. All Rights Reserve"
        + "d.\n"
        + "\n"
        + "     C. In addition, each Contributor must identify itself as the originator of "
        + "its Contribution in a manner that reasonably allows subsequent Recipients to ide"
        + "ntify the originator of the Contribution. Also, each Contributor must agree that"
        + " the additions and/or changes are intended to be a Contribution. Once a Contribu"
        + "tion is contributed, it may not thereafter be revoked.\n"
        + "\n"
