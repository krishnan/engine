...
public class Artistic_2_0 extends License{
   /**
    ...
    public String getTerms(){
        ...
        + "\n"
        + "     \"Contributor\" means any party that has contributed code or other material t"
        + "o the Package, in accordance with the Copyright Holder's procedures.\n"
        + "\n"
        + "     \"You\" and \"your\" means any person who would like to copy, distribute, or mo"
        + "dify the Package.\n"
        + "\n"
        ...
        + "to anyone else, or in the case of a company or organization, to others outside o"
        + "f your company or organization.\n"
        + "\n"
        + "     \"Distributor Fee\" means any fee that you charge for Distributing this Packa"
        + "ge or providing support for this Package to another party.  It does not mean lic"
        + "ensing fees.\n"
        + "\n"
        + "     \"Standard Version\" refers to the Package if it has not been modified, or ha"
        + "s been modified only in ways explicitly requested by the Copyright Holder.\n"
        + "\n"
        + "     \"Modified Version\" means the Package, if it has been changed, and such chan"
        + "ges were not explicitly requested by the Copyright Holder. \n"
        + "\n"
        + "     \"Original License\" means this Artistic License as Distributed with the Stan"
        + "dard Version of the Package, in its current version or as it may be modified by "
        + "The Perl Foundation in the future.\n"
        + "\n"
        + "     \"Source\" form means the source code, documentation source, and configuratio"
        + "n files for the Package.\n"
        + "\n"
        + "     \"Compiled\" form means the compiled bytecode, object code, binary, or any ot"
        + "her form resulting from mechanical transformation or translation of the Source f"
        + "orm.\n"
        + "\n"
        + "Permission for Use and Modification Without Distribution\n"
        + "\n"
        + "(1) You are permitted to use the Standard Version and create and use Modified Ve"
        + "rsions for any purpose without restriction, provided that you do not Distribute "
        + "the Modified Version.\n"
        + "\n"
        + "Permissions for Redistribution of the Standard Version\n"
        + "\n"
        + "(2) You may Distribute verbatim copies of the Source form of the Standard Versio"
        + "n of this Package in any medium without restriction, either gratis or for a Dist"
        + "ributor Fee, provided that you duplicate all of the original copyright notices a"
        + "nd associated disclaimers.  At your discretion, such verbatim copies may or may "
        + "not include a Compiled form of the Package.\n"
        + "\n"
        + "(3) You may apply any bug fixes, portability changes, and other modifications ma"
        + "de available from the Copyright Holder.  The resulting Package will still be con"
        + "sidered the Standard Version, and as such will be subject to the Original Licens"
        + "e.\n"
        + "\n"
        + "Distribution of Modified Versions of the Package as Source \n"
        + "\n"
        + "(4) You may Distribute your Modified Version as Source (either gratis or for a D"
        + "istributor Fee, and with or without a Compiled form of the Modified Version) pro"
        + "vided that you clearly document how it differs from the Standard Version, includ"
        + "ing, but not limited to, documenting any non-standard features, executables, or "
        ...
        + "          (ii) a license that permits the licensee to freely copy, modify and re"
        + "distribute the Modified Version using the same licensing terms that apply to the"
        + " copy that the licensee received, and requires that the Source form of the Modif"
        + "ied Version, and of any works derived from it, be made freely available in that "
