...
public class CC_BY_ND_1_0 extends License{
   /**
    ...
    public String getTerms(){
        ...
        + "ally perform the Work or any Collective Works, You must keep intact all copyrigh"
        + "t notices for the Work and give the Original Author credit reasonable to the med"
        + "ium or means You are utilizing by conveying the name (or pseudonym if applicable"
        + ") of the Original Author if supplied; the title of the Work if supplied. Such cr"
        + "edit may be implemented in any reasonable manner; provided, however, that in the"
        + " case of a Collective Work, at a minimum such credit will appear where any other"
        + " comparable authorship credit appears and in a manner at least as prominent as s"
        + "uch other comparable authorship credit.\n"
        + "\n"
