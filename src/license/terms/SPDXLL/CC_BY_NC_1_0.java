...
public class CC_BY_NC_1_0 extends License{
   /**
    ...
    public String getTerms(){
        ...
        + "tion, fictionalization, motion picture version, sound recording, art reproductio"
        + "n, abridgment, condensation, or any other form in which the Work may be recast, "
        + "transformed, or adapted, except that a work that constitutes a Collective Work w"
        + "ill not be considered a Derivative Work for the purpose of this License.\n"
        + "\n"
        ...
        + " Licensor has secured all rights in the Work necessary to grant the license righ"
        + "ts hereunder and to permit the lawful exercise of the rights granted hereunder w"
        + "ithout You having any obligation to pay any royalties, compulsory license fees, "
        + "residuals or any other payments; The Work does not infringe the copyright, trade"
        + "mark, publicity rights, common law rights or any other right of any third party "
        + "or constitute defamation, invasion of privacy or other tortious injury to any th"
        + "ird party. EXCEPT AS EXPRESSLY STATED IN THIS LICENSE OR OTHERWISE AGREED IN WRI"
        + "TING OR REQUIRED BY APPLICABLE LAW, THE WORK IS LICENSED ON AN \"AS IS\" BASIS, WI"
        + "THOUT WARRANTIES OF ANY KIND, EITHER EXPRESS OR IMPLIED INCLUDING, WITHOUT LIMIT"
        + "ATION, ANY WARRANTIES REGARDING THE CONTENTS OR ACCURACY OF THE WORK.\n"
        + "\n"
