...
public class CC_BY_NC_SA_2_0 extends License{
   /**
    ...
    public String getTerms(){
        ...
        + "ense (e.g. Attribution-NonCommercial-ShareAlike 2.0 Japan). You must include a c"
        + "opy of, or the Uniform Resource Identifier for, this License or other license sp"
        + "ecified in the previous sentence with every copy or phonorecord of each Derivati"
        + "ve Work You distribute, publicly display, publicly perform, or publicly digitall"
        + "y perform. You may not offer or impose any terms on the Derivative Works that al"
        + "ter or restrict the terms of this License or the recipients' exercise of the rig"
        + "hts granted hereunder, and You must keep intact all notices that refer to this L"
        + "icense and to the disclaimer of warranties. You may not distribute, publicly dis"
        + "play, publicly perform, or publicly digitally perform the Derivative Work with a"
        + "ny technological measures that control access or use of the Work in a manner inc"
        + "onsistent with the terms of this License Agreement. The above applies to the Der"
        + "ivative Work as incorporated in a Collective Work, but this does not require the"
        + " Collective Work apart from the Derivative Work itself to be made subject to the"
        + " terms of this License.\n"
        + "\n"
