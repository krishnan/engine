...
public class CC_BY_NC_ND_2_5 extends License{
   /**
    ...
    public String getTerms(){
        ...
        + "nd provide, reasonable to the medium or means You are utilizing: (i) the name of"
        + " the Original Author (or pseudonym, if applicable) if supplied, and/or (ii) if t"
        + "he Original Author and/or Licensor designate another party or parties (e.g. a sp"
        + "onsor institute, publishing entity, journal) for attribution in Licensor's copyr"
        + "ight notice, terms of service or by other reasonable means, the name of such par"
        + "ty or parties; the title of the Work if supplied; and to the extent reasonably p"
        + "racticable, the Uniform Resource Identifier, if any, that Licensor specifies to "
        + "be associated with the Work, unless such URI does not refer to the copyright not"
        + "ice or licensing information for the Work. Such credit may be implemented in any"
        ...
        + "appears and in a manner at least as prominent as such other comparable authorshi"
        + "p credit.\n"
        + "\n"
