...
public class Nunit extends License{
   /**
    ...
    @Override
    public String getId(){
        return "Nunit"; // short and unique id
    }
    ...
    public String getTitle(){
        return "Nunit License"; // full text title
    }
    ...
    public String getTerms(){
        return "Copyright © 2002-2004 James W. Newkirk, Michael C. Two, Alexei A. Vorontsov, Cha"
        + "rlie Poole \n"
        ...
        + "\n"
        + "Portions Copyright © 2002-2004 James W. Newkirk, Michael C. Two, Alexei A. Voron"
        + "tsov, Charlie Poole or Copyright © 2000-2004 Philip A. Craig\n"
        + "\n"
