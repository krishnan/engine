...
public class PDDL_1_0 extends License{
   /**
    ...
    public String getTerms(){
        ...
        + "\n"
        + "     a. A dedication to the public domain and waiver of Copyright and Database R"
        + "ights over the Work; and\n"
        + "\n"
        + "     b. A licence of Copyright and Database Rights over the Work in jurisdiction"
        + "s that do not allow for relinquishment or waiver.\n"
        + "\n"
        + "2.2. Legal rights covered.\n"
        + "\n"
        + "     a. Copyright. Any copyright or neighbouring rights in the Work. Copyright l"
        + "aw varies between jurisdictions, but is likely to cover: the Database model or s"
        + "chema, which is the structure, arrangement, and organisation of the Database, an"
        + "d can also include the Database tables and table indexes; the data entry and out"
        + "put sheets; and the Field names of Data stored in the Database. Copyright may al"
        + "so cover the Data depending on the jurisdiction and type of Data; and\n"
        + "\n"
        + "     b. Database Rights. Database Rights only extend to the extraction and re-ut"
        + "ilisation of the whole or a substantial part of the Data. Database Rights can ap"
        + "ply even when there is no copyright over the Database. Database Rights can also "
        + "apply when the Data is removed from the Database and is selected and arranged in"
        + " a way that would not infringe any applicable copyright.\n"
        + "\n"
        ...
        + "\n"
        + "     c. This Document does not cover any trade marks associated with the Databas"
        + "e. Please see Section 4.3 later in this Document for further details.\n"
        + "\n"
        ...
        + "the Rightsholder has no further rights in Copyright and Database Rights over the"
        + " Work, and that the Work is free and open for others to Use.\n"
        + "\n"
        + "     b. The Rightsholder intends for their relinquishment to cover all present a"
        + "nd future rights in the Work under Copyright and Database Rights, whether they a"
        + "re vested or contingent rights, and that this relinquishment of rights covers al"
        + "l their heirs and successors.\n"
        + "\n"
        ...
        + "ws:\n"
        + "\n"
        + "     a. The Licensor grants to You a worldwide, royalty-free, non-exclusive, lic"
        + "ence to Use the Work for the duration of any applicable Copyright and Database R"
        + "ights. These rights explicitly include commercial use, and do not exclude any fi"
        + "eld of endeavour. To the extent possible in the relevant jurisdiction, these rig"
        + "hts may be exercised in all media and formats whether now known or created in th"
        + "e future.\n"
        + "\n"
        ...
        + "oral rights that Licensor may have in the Work to the fullest extent possible by"
        + " the law of the relevant jurisdiction under Section 6.4;\n"
        + "\n"
        + "     b. If waiver of moral rights under Section 3.4 a in the relevant jurisdicti"
        + "on is not possible, Licensor agrees not to assert any moral rights over the Work"
        ...
        + "l rights under Section 3.4 a and b, the author may retain their moral rights ove"
        + "r the copyrighted aspects of the Work.\n"
        + "\n"
