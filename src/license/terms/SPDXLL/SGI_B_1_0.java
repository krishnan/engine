...
public class SGI_B_1_0 extends License{
   /**
    ...
    public String getTerms(){
        ...
        + "\n"
        + "     1.3 \"Covered Code\" means the Original Code or Modifications or the combinat"
        + "ion of the Original Code and Modifications, in each case including portions ther"
        + "eof.\n"
        + "\n"
        + "     1.4 \"Hardware\" means any physical device that accepts input, processes inpu"
        ...
        + "\n"
        + "     1.6 \"Licensable\" means having the right to grant, to the maximum extent pos"
        ...
        + " Original Code and/or any addition to or deletion from previous Modifications. W"
        ...
        + "/or any addition to or deletion from previous Modifications.\n"
        + "\n"
        ...
        + "escribed in the source code Notice required by Exhibit A as Original Code, and u"
        + "pdates and error corrections specifically thereto.\n"
        + "\n"
        ...
        + "ny entity which controls, is controlled by, or is under common control with Reci"
        + "pient. For purposes of this definition, \"control\" of an entity means (a) the pow"
        + "er, direct or indirect, to direct or manage such entity, or (b) ownership of fif"
        + "ty percent (50%) or more of the outstanding shares or beneficial ownership of su"
        + "ch entity.\n"
        + "\n"
        ...
        + " party intellectual property claims, for the duration of intellectual property p"
        + "rotections inherent in the Original Code, SGI hereby grants Recipient a worldwid"
        + "e, royalty-free, non-exclusive license, to do the following: (i) under copyright"
        + "s Licensable by SGI, to reproduce, distribute, create derivative works from, and"
        + ", to the extent applicable, display and perform the Original Code alone and/or a"
        + "s part of a Larger Work; and (ii) under any patent claims Licensable by SGI and "
        + "embodied in the Original Code, to make, have made, use, practice, sell, and offe"
        + "r for sale, and/or otherwise dispose of the Original Code. Recipient accepts the"
        + " terms and conditions of this License by undertaking any of the aforementioned a"
        + "ctions.\n"
        + "\n"
        + "     2.2 Restriction on Patent License. Notwithstanding the provisions of Sectio"
        + "n 2.1(ii), no patent license is granted: 1) separate from the Original Code; nor"
        + " 2) for infringements caused by (i) modification of the Original Code, or (ii) t"
        + "he combination of the Original Code with other software or Hardware.\n"
        + "\n"
        + "     2.3 No License For Hardware Implementations. The licenses granted in Sectio"
        + "n 2.1 are not applicable to implementation in Hardware of the algorithms embodie"
        + "d in the Original Code.\n"
        + "\n"
        + "     2.4 Modifications License and API Compliance. Modifications are only licens"
        + "ed under Section 2.1(i) to the extent such Modifications are fully compliant wit"
        + "h any API as may be identified in Additional Notice Provisions as appear in the "
        + "Original Code.\n"
        + "\n"
        + "3. Redistributions.\n"
        + "\n"
        ...
        + " Notice must appear in every file that can include a text comments field; in exe"
        + "cutable form, the Notice and a copy of this License must appear in related docum"
        + "entation or collateral where the Recipient’s rights relating to Covered Code are"
        + " described. Any Additional Notice Provisions which actually appears in the Origi"
        + "nal Code must also be retained or included in any and all redistributions of Cov"
        + "ered Code.\n"
        + "\n"
        + "     B.Alternative License. Provided that Recipient is in compliance with the t"
        + "erms of this License, Recipient may distribute the source code and/or executable"
        ...
        + "ient’s role as licensor of Modifications, without derogation of any of SGI’s rig"
        + "hts; and/or (3) a license of Recipient’s choosing, containing terms different fr"
        + "om this License, provided that the license terms include this Section 3 and Sect"
        + "ions 4, 6, 7, 10, 12, and 13, which terms may not be modified or superseded by a"
        + "ny other terms of such license. If Recipient elects to use any license other tha"
        + "n this License, Recipient must make it absolutely clear that any of its terms wh"
        + "ich differ from this License are offered by Recipient alone, and not by SGI.\n"
        + "\n"
        + "     C.Indemnity. Recipient hereby agrees to indemnify SGI for any liability in"
        + "curred by SGI as a result of any such alternative license terms Recipient offers"
        + ".\n"
        + "\n"
