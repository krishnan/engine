...
public class OLDAP_1_3 extends License{
   /**
    ...
    public String getTerms(){
        ...
        + "Package and do not automatically fall under the copyright of this Package, and t"
        + "he executables produced by linking your software with this Package may be used a"
        + "nd redistributed without restriction and may be sold commercially.\n"
        + "\n"
