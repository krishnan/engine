...
public class Zimbra_1_3 extends License{
   /**
    ...
    public String getTerms(){
        ...
        + "ill apply to You in the same way those terms apply to VMware with respect to the"
        + " Software. In other words, when You are distributing Modifications under this Ag"
        + "reement, You \"stand in the shoes\" of VMware in terms of the rights You grant and"
        + " how the terms and conditions apply to You and the licensees of Your Modificatio"
        + "ns. Notwithstanding the foregoing, when You \"stand in the shoes\" of VMware, You "
        ...
        + "m this Agreement are offered by You alone and not by VMware, and that such licen"
        + "se does not restrict recipients from exercising rights in the source code to the"
        + " Software granted by VMware under this Agreement or rights in the source code to"
        ...
        + "\n"
        + "     6.2 - In the event You violate the terms of this Agreement, VMware may term"
        ...
        + "ilable to VMware at law or equity or under this Agreement.\n"
        + "\n"
        + "     6.4 - Termination of this Agreement will not affect the provisions regardin"
        + "g reservation of rights (Section 3.1), provisions disclaiming or limiting VMware"
