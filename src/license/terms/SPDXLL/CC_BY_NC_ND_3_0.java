...
public class CC_BY_NC_ND_3_0 extends License{
   /**
    ...
    public String getTerms(){
        ...
        + " but otherwise you have no rights to make Adaptations. Subject to 8(f), all righ"
        + "ts not expressly granted by Licensor are hereby reserved, including but not limi"
        + "ted to the rights set forth in Section 4(d).\n"
        + "\n"
        ...
        + "ove from the Collection any credit as required by Section 4(c), as requested.\n"
        + "\n"
        ...
        + "dit required by this Section 4(c) may be implemented in any reasonable manner; p"
        + "rovided, however, that in the case of a Collection, at a minimum such credit wil"
        + "l appear, if a credit for all contributing authors of Collection appears, then a"
        + "s part of these credits and in a manner at least as prominent as the credits for"
        + " the other contributing authors. For the avoidance of doubt, You may only use th"
        + "e credit required by this Section for the purpose of attribution in the manner s"
        + "et out above and, by exercising Your rights under this License, You may not impl"
        + "icitly or explicitly assert or imply any connection with, sponsorship or endorse"
        + "ment by the Original Author, Licensor and/or Attribution Parties, as appropriate"
        + ", of You or Your use of the Work, without the separate, express prior written pe"
        + "rmission of the Original Author, Licensor and/or Attribution Parties.\n"
        + "\n"
