...
public class CPAL_1_0 extends License{
   /**
    ...
    public String getTerms(){
        ...
        + " know whom to contact. If Contributor obtains such knowledge after the Modificat"
        + "ion is made available as described in Section 3.2, Contributor shall promptly mo"
        + "dify the LEGAL file in all copies Contributor makes available thereafter and sha"
        + "ll take other steps (such as notifying appropriate mailing lists or newsgroups) "
        + "reasonably calculated to inform those who received the Covered Code that new kno"
        + "wledge has been obtained.\n"
        + "\n"
        + "     (b) Contributor APIs.  If Contributor’s Modifications include an applicatio"
        + "n programming interface and Contributor has knowledge of patent licenses which a"
        + "re reasonably necessary to implement that API, Contributor must also include thi"
        + "s information in the LEGAL file.\n"
        + "\n"
        ...
        + " any patent, then any and all rights granted by such Participant to You under Se"
        + "ctions 2.1 and/or 2.2 of this License shall, upon 60 days notice from Participan"
        + "t terminate prospectively, unless if within 60 days after receipt of notice You "
        ...
        + "or (ii) withdraw Your litigation claim with respect to the Contributor Version a"
        + "gainst such Participant. If within 60 days of notice, a reasonable royalty and p"
        + "ayment arrangement are not mutually agreed upon in writing by the parties or the"
        + " litigation claim is not withdrawn, the rights granted by Participant to You und"
        + "er Sections 2.1 and/or 2.2 automatically terminate at the expiration of the 60 d"
        + "ay notice period specified above.\n"
        + "\n"
        + "     (b) any software, hardware, or device, other than such Participant’s Contri"
        + "butor Version, directly or indirectly infringes any patent, then any rights gran"
        + "ted to You by such Participant under Sections 2.1(b) and 2.2(b) are revoked effe"
        + "ctive as of the date You first made, used, sold, distributed, or had made, Modif"
        + "ications made by that Participant.\n"
        + "\n"
        ...
        + "\n"
        + "     (a) As a modest attribution to the organizer of the development of the Orig"
        + "inal Code (“Original Developer”), in the hope that its promotional value may hel"
        + "p justify the time, money and effort invested in writing the Original Code, the "
        + "Original Developer may include in Exhibit B (“Attribution Information”) a requir"
        + "ement that each time an Executable and Source Code or a Larger Work is launched "
        + "or initially run (which includes initiating a session), a prominent display of t"
        + "he Original Developer’s Attribution Information (as defined below) must occur on"
        + " the graphic user interface employed by the end user to access such Covered Code"
        + " (which may include display on a splash screen), if any. The size of the graphic"
        + " image should be consistent with the size of the other elements of the Attributi"
        + "on Information. If the access by the end user to the Executable and Source Code "
        + "does not create a graphic user interface for access to the Covered Code, this ob"
        + "ligation shall not apply. If the Original Code displays such Attribution Informa"
        + "tion in a particular form (such as in the form of a splash screen, notice at log"
        + "in, an “about” display, or dedicated attribution area on user interface screens)"
        + ", continued use of such form for that Attribution Information is one way of meet"
        + "ing this requirement for notice.\n"
        + "\n"
        + "     (b) Attribution information may only include a copyright notice, a brief ph"
        + "rase, graphic image and a URL (“Attribution Information”) and is subject to the "
        + "Attribution Limits as defined below. For these purposes, prominent shall mean di"
        + "splay for sufficient duration to give reasonable notice to the user of the ident"
        + "ity of the Original Developer and that if You include Attribution Information or"
        + " similar information for other parties, You must ensure that the Attribution Inf"
        + "ormation for the Original Developer shall be no less prominent than such Attribu"
        + "tion Information or similar information for the other party. For greater certain"
        + "ty, the Original Developer may choose to specify in Exhibit B below that the abo"
        + "ve attribution requirement only applies to an Executable and Source Code resulti"
        + "ng from the Original Code or any Modification, but not a Larger Work. The intent"
        + " is to provide for reasonably modest attribution, therefore the Original Develop"
        + "er cannot require that You display, at any time, more than the following informa"
        + "tion as Attribution Information: (a) a copyright notice including the name of th"
        + "e Original Developer; (b) a word or one phrase (not exceeding 10 words); (c) one"
        + " graphic image provided by the Original Developer; and (d) a URL (collectively, "
        + "the “Attribution Limits”).\n"
        + "\n"
        + "     (c) If Exhibit B does not include any Attribution Information, then there a"
        + "re no requirements for You to display any Attribution Information of the Origina"
        + "l Developer.\n"
        + "\n"
        + "     (d) You acknowledge that all trademarks, service marks and/or trade names c"
        + "ontained within the Attribution Information distributed with the Covered Code ar"
        + "e the exclusive property of their owners and may only be used with the permissio"
        + "n of their owners, or under circumstances otherwise permitted by law or as expre"
        + "ssly set out in this License.\n"
        + "\n"
