...
public class CC_BY_2_0 extends License{
   /**
    ...
    public String getTerms(){
        ...
        + "RMATION PROVIDED, AND DISCLAIMS LIABILITY FOR DAMAGES RESULTING FROM ITS USE.<<e"
        + "ndOptional>>\n"
        + "\n"
        + "License\n"
        + "\n"
        ...
        + "lusive right to collect, whether individually or via a music rights agency or de"
        + "signated agent (e.g. Harry Fox Agency), royalties for any phonorecord You create"
        + " from the Work (\"cover version\") and distribute, subject to the compulsory licen"
        + "se created by 17 USC Section 115 of the US Copyright Act (or the equivalent in o"
        + "ther jurisdictions).\n"
        + "\n"
        + "     f. Webcasting Rights and Statutory Royalties. For the avoidance of doubt, w"
        ...
        + "if supplied; to the extent reasonably practicable, the Uniform Resource Identifi"
        + "er, if any, that Licensor specifies to be associated with the Work, unless such "
        ...
        + " in the Derivative Work (e.g., \"French translation of the Work by Original Autho"
        + "r,\" or \"Screenplay based on original Work by Original Author\"). Such credit may "
        + "be implemented in any reasonable manner; provided, however, that in the case of "
        + "a Derivative Work or Collective Work, at a minimum such credit will appear where"
        + " any other comparable authorship credit appears and in a manner at least as prom"
        + "inent as such other comparable authorship credit.\n"
        + "\n"
