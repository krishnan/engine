...
public class SGI_B_1_1 extends License{
   /**
    ...
    public String getTerms(){
        ...
        + "1. Definitions.\n"
        + "\n"
        + "     1.1 \"Additional Notice Provisions\" means such additional provisions as appe"
        + "ar in the Notice in Original Code under the heading \"Additional Notice Provision"
        + "s.\"\n"
        + "\n"
        + "     1.2 \"Covered Code\" means the Original Code or Modifications, or any combina"
        + "tion thereof.\n"
        + "\n"
        + "     1.3 \"Hardware\" means any physical device that accepts input, processes inpu"
        + "t, stores the results of processing, and/or provides output.\n"
        + "\n"
        + "     1.4 \"Larger Work\" means a work that combines Covered Code or portions there"
        + "of with code not governed by the terms of this License.\n"
        + "\n"
        + "     1.5 \"Licensable\" means having the right to grant, to the maximum extent pos"
        + "sible, whether at the time of the initial grant or subsequently acquired, any an"
        + "d all of the rights conveyed herein.\n"
        + "\n"
        + "     1.6 \"License\" means this document.\n"
        + "\n"
        + "     1.7 \"Licensed Patents\" means patent claims Licensable by SGI that are infri"
        + "nged by the use or sale of Original Code or any Modifications provided by SGI, o"
        ...
        + "\n"
        + "          A. Any addition to the contents of a file containing Original Code and"
        + "/or addition to or deletion from the contents of a file containing previous Modi"
        + "fications.\n"
        + "\n"
        ...
        + "\n"
        + "     1.10 \"Original Code\" means source code of computer software code that is de"
        + "scribed in the source code Notice required by Exhibit A as Original Code, and up"
        + "dates and error corrections specifically thereto.\n"
        + "\n"
        + "     1.11 \"Recipient\" means an individual or a legal entity exercising rights un"
        + "der, and complying with all of the terms of, this License or a future version of"
        + " this License issued under Section 8. For legal entities, \"Recipient\" includes a"
        + "ny entity that controls, is controlled by, or is under common control with Recip"
        + "ient. For purposes of this definition, \"control\" of an entity means (a) the powe"
        + "r, direct or indirect, to direct or manage such entity, or (b) ownership of fift"
        + "y percent (50%) or more of the outstanding shares or beneficial ownership of suc"
        + "h entity.\n"
        + "\n"
        ...
        + "\n"
        + "     1.14 \"SGI Patents\" means patent claims Licensable by SGI other than the Lic"
        + "ensed Patents.\n"
        + "\n"
        + "2. License Grant and Restrictions.\n"
        + "\n"
        + "     2.1 SGI License Grant. Subject to the terms of this License and any third p"
        + "arty intellectual property claims, for the duration of intellectual property pro"
        + "tections inherent in the Original Code, SGI hereby grants Recipient a worldwide,"
        + " royalty-free, non-exclusive license, to do the following: (i) under copyrights "
        + "Licensable by SGI, to reproduce, distribute, create derivative works from, and, "
        + "to the extent applicable, display and perform the Original Code and/or any Modif"
        + "ications provided by SGI alone and/or as part of a Larger Work; and (ii) under a"
        + "ny Licensable Patents, to make, have made, use, sell, offer for sale, import and"
        + "/or otherwise transfer the Original Code and/or any Modifications provided by SG"
        + "I. Recipient accepts the terms and conditions of this License by undertaking any"
        + " of the aforementioned actions. The patent license shall apply to the Covered Co"
        + "de if, at the time any related Modification is added, such addition of the Modif"
        + "ication causes such combination to be covered by the Licensed Patents. The paten"
        + "t license in Section 2.1(ii) shall not apply to any other combinations that incl"
        + "ude the Modification. No patent license is provided under SGI Patents for infrin"
        + "gements of SGI Patents by Modifications not provided by SGI or combinations of O"
        + "riginal Code and Modifications not provided by SGI. \n"
        + "\n"
        + "     2.2 Recipient License Grant. Subject to the terms of this License and any t"
        + "hird party intellectual property claims, Recipient hereby grants SGI and any oth"
        + "er Recipients a worldwide, royalty-free, non-exclusive license, under any Recipi"
        + "ent Patents, to make, have made, use, sell, offer for sale, import and/or otherw"
        + "ise transfer the Original Code and/or any Modifications provided by SGI.\n"
        + "\n"
        + "     2.3 No License For Hardware Implementations. The licenses granted in Sectio"
        + "n 2.1 and 2.2 are not applicable to implementation in Hardware of the algorithms"
        ...
        + " below, must be conspicuously retained or included in any and all redistribution"
        + "s of Covered Code. For distributions of the Covered Code in source code form, th"
        + "e Notice must appear in every file that can include a text comments field; in ex"
        + "ecutable form, the Notice and a copy of this License must appear in related docu"
        + "mentation or collateral where the Recipient’s rights relating to Covered Code ar"
        + "e described. Any Additional Notice Provisions which actually appears in the Orig"
        + "inal Code must also be retained or included in any and all redistributions of Co"
        + "vered Code.\n"
        + "\n"
        + "     3.2 Alternative License. Provided that Recipient is in compliance with the "
        + "terms of this License, Recipient may, so long as without derogation of any of SG"
        + "I’s rights in and to the Original Code, distribute the source code and/or execut"
        + "able version(s) of Covered Code under (1) this License; (2) a license identical "
        + "to this License but for only such changes as are necessary in order to clarify R"
        + "ecipient’s role as licensor of Modifications; and/or (3) a license of Recipient’"
        + "s choosing, containing terms different from this License, provided that the lice"
        + "nse terms include this Section 3 and Sections 4, 6, 7, 10, 12, and 13, which ter"
        + "ms may not be modified or superseded by any other terms of such license. If Reci"
        + "pient elects to use any license other than this License, Recipient must make it "
        + "absolutely clear that any of its terms which differ from this License are offere"
        + "d by Recipient alone, and not by SGI. It is emphasized that this License is a li"
        + "mited license, and, regardless of the license form employed by Recipient in acco"
        + "rdance with this Section 3.2, Recipient may relicense only such rights, in Origi"
        + "nal Code and Modifications by SGI, as it has actually been granted by SGI in thi"
        + "s License.\n"
        + "\n"
        + "     3.3 Indemnity. Recipient hereby agrees to indemnify SGI for any liability i"
        + "ncurred by SGI as a result of any such alternative license terms Recipient offer"
        + "s.\n"
        + "\n"
