...
public class CC_BY_ND_2_0 extends License{
   /**
    ...
    public String getTerms(){
        ...
        + "tices for the Work and give the Original Author credit reasonable to the medium "
        ...
        + "extent reasonably practicable, the Uniform Resource Identifier, if any, that Lic"
        + "ensor specifies to be associated with the Work, unless such URI does not refer t"
        + "o the copyright notice or licensing information for the Work. Such credit may be"
        ...
        + " authorship credit appears and in a manner at least as prominent as such other c"
        + "omparable authorship credit.\n"
        + "\n"
        ...
        + "he party to be charged with such waiver or consent. This License constitutes the"
        + " entire agreement between the parties with respect to the Work licensed here. Th"
        + "ere are no understandings, agreements or representations with respect to the Wor"
        + "k not specified here. Licensor shall not be bound by any additional provisions t"
        + "hat may appear in any communication from You.\n"
        + "\n"
