...
public class EFL_2_0 extends License{
   /**
    ...
    public String getTerms(){
        ...
        + "\n"
        + "1. Permission is hereby granted to use, copy, modify and/or distribute this pack"
        + "age, provided that: \n"
        ...
        + "on this package. If the binary program depends on a modified version of this pac"
        + "kage, you are encouraged to publicly release the modified version of this packag"
        + "e. \n"
        + "\n"
