...
public class CC_BY_3_0 extends License{
   /**
    ...
    public String getTerms(){
        ...
        + "ove from the Collection any credit as required by Section 4(b), as requested. If"
        + " You create an Adaptation, upon notice from any Licensor You must, to the extent"
        + " practicable, remove from the Adaptation any credit as required by Section 4(b),"
        + " as requested.\n"
        + "\n"
        + "     b. If You Distribute, or Publicly Perform the Work or any Adaptations or Co"
        ...
        + "r the Work; and (iv) , consistent with Section 3(b), in the case of an Adaptatio"
        + "n, a credit identifying the use of the Work in the Adaptation (e.g., \"French tra"
        + "nslation of the Work by Original Author,\" or \"Screenplay based on original Work "
        + "by Original Author\"). The credit required by this Section 4 (b) may be implement"
