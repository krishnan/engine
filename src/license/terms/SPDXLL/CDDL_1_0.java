...
public class CDDL_1_0 extends License{
   /**
    ...
    public String getTerms(){
        ...
        + " of the contents of a file containing Original Software or previous Modification"
        + "s;\n"
        + "\n"
        + "     B. Any new file that contains any part of the Original Software or previous"
        + " Modification; or\n"
        + "\n"
        + "     C. Any new file that is contributed or otherwise made available under the t"
        ...
        + "ensable by Initial Developer, to use, reproduce, modify, display, perform, subli"
        + "cense and distribute the Original Software (or portions thereof), with or withou"
        + "t Modifications, and/or as part of a Larger Work; and\n"
        + "\n"
        + "     (b) under Patent Claims infringed by the making, using or selling of Origin"
        + "al Software, to make, have made, use, practice, sell, and offer for sale, and/or"
        + " otherwise dispose of the Original Software (or portions thereof).\n"
        + "\n"
        + "     (c) The licenses granted in Sections 2.1(a) and (b) are effective on the da"
        + "te Initial Developer first distributes or otherwise makes the Original Software "
        + "available to a third party under the terms of this License.\n"
        + "\n"
        + "     (d) Notwithstanding Section 2.1(b) above, no patent license is granted: (1)"
        + " for code that You delete from the Original Software, or (2) for infringements c"
        + "aused by: (i) the modification of the Original Software, or (ii) the combination"
        ...
        + "\n"
        + "     (a) under intellectual property rights (other than patent or trademark) Lic"
        + "ensable by Contributor to use, reproduce, modify, display, perform, sublicense a"
        + "nd distribute the Modifications created by such Contributor (or portions thereof"
        ...
        + "or sale, have made, and/or otherwise dispose of: (1) Modifications made by that "
        + "Contributor (or portions thereof); and (2) the combination of Modifications made"
        + " by that Contributor with its Contributor Version (or portions of such combinati"
        + "on).\n"
        + "\n"
        + "     (c) The licenses granted in Sections 2.2(a) and 2.2(b) are effective on the"
        + " date Contributor first distributes or otherwise makes the Modifications availab"
        + "le to a third party.\n"
        + "\n"
        ...
        + "or (ii) the combination of Modifications made by that Contributor with other sof"
        + "tware (except as part of the Contributor Version) or other devices; or (3) under"
        + " Patent Claims infringed by Covered Software in the absence of Modifications mad"
        + "e by that Contributor.\n"
        + "\n"
