...
public class AFL_3_0 extends License{
   /**
    ...
    public String getTerms(){
        ...
        + "Works to the public, under any license of your choice that does not contradict t"
        + "he terms and conditions, including Licensor’s reserved rights and remedies, in t"
        + "his Academic Free License;\n"
