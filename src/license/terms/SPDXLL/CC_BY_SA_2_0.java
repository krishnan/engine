...
public class CC_BY_SA_2_0 extends License{
   /**
    ...
    public String getTerms(){
        ...
        + "tally perform a Derivative Work only under the terms of this License, a later ve"
        + "rsion of this License with the same License Elements as this License, or a Creat"
        + "ive Commons iCommons license that contains the same License Elements as this Lic"
        + "ense (e.g. Attribution-ShareAlike 2.0 Japan). You must include a copy of, or the"
        + " Uniform Resource Identifier for, this License or other license specified in the"
        + " previous sentence with every copy or phonorecord of each Derivative Work You di"
        + "stribute, publicly display, publicly perform, or publicly digitally perform. You"
        + " may not offer or impose any terms on the Derivative Works that alter or restric"
        + "t the terms of this License or the recipients' exercise of the rights granted he"
        + "reunder, and You must keep intact all notices that refer to this License and to "
        + "the disclaimer of warranties. You may not distribute, publicly display, publicly"
        + " perform, or publicly digitally perform the Derivative Work with any technologic"
        + "al measures that control access or use of the Work in a manner inconsistent with"
        + " the terms of this License Agreement. The above applies to the Derivative Work a"
        + "s incorporated in a Collective Work, but this does not require the Collective Wo"
        + "rk apart from the Derivative Work itself to be made subject to the terms of this"
        + " License.\n"
        + "\n"
        ...
        + "\n"
        + "UNLESS OTHERWISE AGREED TO BY THE PARTIES IN WRITING, LICENSOR OFFERS THE WORK A"
        + "S-IS AND MAKES NO REPRESENTATIONS OR WARRANTIES OF ANY KIND CONCERNING THE MATER"
        + "IALS, EXPRESS, IMPLIED, STATUTORY OR OTHERWISE, INCLUDING, WITHOUT LIMITATION, W"
        + "ARRANTIES OF TITLE, MERCHANTIBILITY, FITNESS FOR A PARTICULAR PURPOSE, NONINFRIN"
        + "GEMENT, OR THE ABSENCE OF LATENT OR OTHER DEFECTS, ACCURACY, OR THE PRESENCE OF "
