...
public class CC_BY_2_5 extends License{
   /**
    ...
    public String getTerms(){
        ...
        + " from the Derivative Work any credit as required by clause 4(b), as requested.\n"
        + "\n"
        ...
        + "if applicable) if supplied, and/or (ii) if the Original Author and/or Licensor d"
        + "esignate another party or parties (e.g. a sponsor institute, publishing entity, "
        ...
        + " if supplied; to the extent reasonably practicable, the Uniform Resource Identif"
        + "ier, if any, that Licensor specifies to be associated with the Work, unless such"
        + " URI does not refer to the copyright notice or licensing information for the Wor"
        + "k; and in the case of a Derivative Work, a credit identifying the use of the Wor"
        + "k in the Derivative Work (e.g., \"French translation of the Work by Original Auth"
        + "or,\" or \"Screenplay based on original Work by Original Author\"). Such credit may"
        + " be implemented in any reasonable manner; provided, however, that in the case of"
        + " a Derivative Work or Collective Work, at a minimum such credit will appear wher"
        + "e any other comparable authorship credit appears and in a manner at least as pro"
        + "minent as such other comparable authorship credit.\n"
        + "\n"
