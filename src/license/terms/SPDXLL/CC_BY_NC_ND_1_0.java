...
public class CC_BY_NC_ND_1_0 extends License{
   /**
    ...
    public String getTerms(){
        ...
        + "W FIRM AND DOES NOT PROVIDE LEGAL SERVICES. DISTRIBUTION OF THIS DRAFT LICENSE D"
        + "OES NOT CREATE AN ATTORNEY-CLIENT RELATIONSHIP. CREATIVE COMMONS PROVIDES THIS I"
        + "NFORMATION ON AN \"AS-IS\" BASIS. CREATIVE COMMONS MAKES NO WARRANTIES REGARDING T"
        + "HE INFORMATION PROVIDED, AND DISCLAIMS LIABILITY FOR DAMAGES RESULTING FROM ITS "
        + "USE. <<endOptional>>\n"
        + "\n"
        + "License\n"
        + "\n"
