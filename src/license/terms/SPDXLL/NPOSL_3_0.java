...
public class NPOSL_3_0 extends License{
   /**
    ...
    public String getTerms(){
        ...
        + " following:\n"
        + "\n"
        + "     a) to reproduce the Original Work in copies, either alone or as part of a c"
        + "ollective work;\n"
        + "\n"
        + "     b) to translate, adapt, alter, transform, modify, or arrange the Original W"
        ...
        + " Works that You distribute or communicate shall be licensed under this Non-Profi"
        + "t Open Software License or as provided in section 17(d);\n"
        + "\n"
        ...
        + "\n"
        + "     (a) Licensor represents and declares that it is a not-for-profit organizati"
        + "on that derives no revenue whatsoever from the distribution of the Original Work"
        + " or Derivative Works thereof, or from support or services relating thereto.\n"
        + "\n"
        + "     (b) The first sentence of Section 7 [\"Warranty of Provenance\"] of OSL 3.0 h"
        + "as been stricken. For Original Works licensed under this Non-Profit OSL 3.0, LIC"
        + "ENSOR OFFERS NO WARRANTIES WHATSOEVER.\n"
        + "\n"
        + "     (c) In the first sentence of Section 8 [\"Limitation of Liability\"] of this "
        + "Non-Profit OSL 3.0, the list of damages for which LIABILITY IS LIMITED now inclu"
        + "des \"direct\" damages.\n"
        + "\n"
        + "     (d) The proviso in Section 1(c) of this License now refers to this \"Non-Pro"
        + "fit Open Software License\" rather than the \"Open Software License\". You may dist"
        + "ribute or communicate the Original Work or Derivative Works thereof under this N"
        + "on-Profit OSL 3.0 license only if You make the representation and declaration in"
        + " paragraph (a) of this Section 17. Otherwise, You shall distribute or communicat"
        + "e the Original Work or Derivative Works thereof only under the OSL 3.0 license a"
        + "nd You shall publish clear licensing notices so stating. Also by way of clarific"
        + "ation, this License does not authorize You to distribute or communicate works un"
        + "der this Non-Profit OSL 3.0 if You received them under the original OSL 3.0 lice"
        + "nse.\n"
        + "\n"
