...
public class CC_BY_NC_2_5 extends License{
   /**
    ...
    public String getTerms(){
        ...
        + " terms of this License. \"Original Author\" means the individual or entity who cre"
        + "ated the Work.\n"
        + "\n"
        + "     d. \"Work\" means the copyrightable work of authorship offered under the term"
        + "s of this License.\n"
        + "\n"
        ...
        + "f the rights granted hereunder.\n"
        + "\n"
        + "     b. You may not sublicense the Work. You must keep intact all notices that r"
        + "efer to this License and to the disclaimer of warranties. You may not distribute"
        + ", publicly display, publicly perform, or publicly digitally perform the Work wit"
        + "h any technological measures that control access or use of the Work in a manner "
        + "inconsistent with the terms of this License Agreement. The above applies to the "
        + "Work as incorporated in a Collective Work, but this does not require the Collect"
        + "ive Work apart from the Work itself to be made subject to the terms of this Lice"
        + "nse. If You create a Collective Work, upon notice from any Licensor You must, to"
        + " the extent practicable, remove from the Collective Work any credit as required "
        + "by clause 4(c), as requested. If You create a Derivative Work, upon notice from "
        + "any Licensor You must, to the extent practicable, remove from the Derivative Wor"
        + "k any credit as required by clause 4(c), as requested. You may not exercise any "
        + "of the rights granted to You in Section 3 above in any manner that is primarily "
        + "intended for or directed toward commercial advantage or private monetary compens"
        + "ation. The exchange of the Work for other copyrighted works by means of digital "
        ...
        + " no payment of any monetary compensation in connection with the exchange of copy"
        + "righted works.\n"
        + "\n"
        ...
        + " or means You are utilizing: (i) the name of Original Author (or pseudonym, if a"
        + "pplicable) if supplied, and/or (ii) if the Original Author and/or Licensor desig"
        + "nate another party or parties (e.g. a sponsor institute, publishing entity, jour"
        + "nal) for attribution in Licensor's copyright notice, terms of service or by othe"
        + "r reasonable means, the name of such party or parties; the title of the Work if "
        ...
        + " does not refer to the copyright notice or licensing information for the Work; a"
        + "nd in the case of a Derivative Work, a credit identifying the use of the Work in"
        ...
        + "implemented in any reasonable manner; provided, however, that in the case of a D"
        + "erivative Work or Collective Work, at a minimum such credit will appear where an"
        + "y other comparable authorship credit appears and in a manner at least as promine"
        + "nt as such other comparable authorship credit.\n"
        + "\n"
