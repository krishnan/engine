...
public class MirOS extends License{
   /**
    ...
    public String getTerms(){
        ...
        + "To apply the template(1) specify the years of copyright (separated by comma, not"
        + " as a range), the legal names of the copyright holders, and the real names of th"
        + "e authors if different. Avoid adding text.\n"
        + "\n"
        + "R_A_T_I_O_N_A_L_E_:_ \n"
        + "This licence is apt for any kind of work (such as source code, fonts, documentat"
        + "ion, graphics, sound etc.) and the preferred terms for work added to MirBSD. It "
        + "has been drafted as universally usable equivalent of the \"historic permission no"
        + "tice\"(2) adapted to Europen law because in some (droit d'auteur) countries autho"
        + "rs cannot disclaim all liabi‐ lities. Compliance to DFSG(3) 1.1 is ensured, and "
        + "GPLv2 compatibility is asserted unless advertising clauses are used. The MirOS L"
        + "icence is certified to conform to OKD(4) 1.0 and OSD(5) 1.9, and qualifies as a "
        + "Free Software(6) and also Free Documentation(7) licence and is included in some "
        + "relevant lists(8)(9)(10).\n"
        + "\n"
        + "We believe you are not liable for work inserted which is intellectual property o"
        + "f third parties, if you were not aware of the fact, act appropriately as soon as"
        + " you become aware of that problem, seek an amicable solution for all parties, an"
        + "d never knowingly distribute a work without being authorised to do so by its lic"
        + "ensors.\n"
        + "\n"
