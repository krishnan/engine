...
public class CC_BY_NC_2_0 extends License{
   /**
    ...
    public String getTerms(){
        ...
        + "ntended for or directed toward commercial advantage or private monetary compensa"
        + "tion. Webcasting Rights and Statutory Royalties. For the avoidance of doubt, whe"
        + "re the Work is a sound recording, Licensor reserves the exclusive right to colle"
        ...
        + "Act (or the equivalent in other jurisdictions), if Your public digital performan"
        + "ce is primarily intended for or directed toward commercial advantage or private "
