...
public class CC_BY_SA_1_0 extends License{
   /**
    ...
    public String getTerms(){
        ...
        + " FIRM AND DOES NOT PROVIDE LEGAL SERVICES. DISTRIBUTION OF THIS DRAFT LICENSE DO"
        + "ES NOT CREATE AN ATTORNEY-CLIENT RELATIONSHIP. CREATIVE COMMONS PROVIDES THIS IN"
        + "FORMATION ON AN \"AS-IS\" BASIS. CREATIVE COMMONS MAKES NO WARRANTIES REGARDING TH"
        + "E INFORMATION PROVIDED, AND DISCLAIMS LIABILITY FOR DAMAGES RESULTING FROM ITS U"
        + "SE. <<endOptional>>\n"
        + "\n"
        + "License\n"
        + "\n"
        ...
        + "ll not be considered a Derivative Work for the purpose of this License.\n"
        + "\n"
        ...
        + "\n"
        + "     c. to distribute copies or phonorecords of, display publicly, perform publi"
        + "cly, and perform publicly by means of a digital audio transmission the Work incl"
        + "uding as incorporated in Collective Works;\n"
        + "\n"
        + "     d. to distribute copies or phonorecords of, display publicly, perform publi"
        + "cly, and perform publicly by means of a digital audio transmission Derivative Wo"
        + "rks;\n"
        + "\n"
        ...
        + " any reference to such Licensor or the Original Author, as requested. If You cre"
        + "ate a Derivative Work, upon notice from any Licensor You must, to the extent pra"
        + "cticable, remove from the Derivative Work any reference to such Licensor or the "
        + "Original Author, as requested.\n"
        + "\n"
        + "     b. You may distribute, publicly display, publicly perform, or publicly digi"
        + "tally perform a Derivative Work only under the terms of this License, and You mu"
        + "st include a copy of, or the Uniform Resource Identifier for, this License with "
        + "every copy or phonorecord of each Derivative Work You distribute, publicly displ"
        + "ay, publicly perform, or publicly digitally perform. You may not offer or impose"
        + " any terms on the Derivative Works that alter or restrict the terms of this Lice"
        + "nse or the recipients' exercise of the rights granted hereunder, and You must ke"
        + "ep intact all notices that refer to this License and to the disclaimer of warran"
        + "ties. You may not distribute, publicly display, publicly perform, or publicly di"
        + "gitally perform the Derivative Work with any technological measures that control"
        + " access or use of the Work in a manner inconsistent with the terms of this Licen"
        + "se Agreement. The above applies to the Derivative Work as incorporated in a Coll"
        + "ective Work, but this does not require the Collective Work apart from the Deriva"
        + "tive Work itself to be made subject to the terms of this License.\n"
        + "\n"
        + "     c. If you distribute, publicly display, publicly perform, or publicly digit"
        + "ally perform the Work or any Derivative Works or Collective Works, You must keep"
        + " intact all copyright notices for the Work and give the Original Author credit r"
        + "easonable to the medium or means You are utilizing by conveying the name (or pse"
        + "udonym if applicable) of the Original Author if supplied; the title of the Work "
        + "if supplied; in the case of a Derivative Work, a credit identifying the use of t"
        + "he Work in the Derivative Work (e.g., \"French translation of the Work by Origina"
        + "l Author,\" or \"Screenplay based on original Work by Original Author\"). Such cred"
        + "it may be implemented in any reasonable manner; provided, however, that in the c"
        + "ase of a Derivative Work or Collective Work, at a minimum such credit will appea"
        + "r where any other comparable authorship credit appears and in a manner at least "
        + "as prominent as such other comparable authorship credit.\n"
        + "\n"
        + "5. Representations, Warranties and Disclaimer\n"
        + "\n"
        + "     a. By offering the Work for public release under this License, Licensor rep"
        + "resents and warrants that, to the best of Licensor's knowledge after reasonable "
        + "inquiry:\n"
        + "\n"
        + "           i. Licensor has secured all rights in the Work necessary to grant the"
        + " license rights hereunder and to permit the lawful exercise of the rights grante"
        + "d hereunder without You having any obligation to pay any royalties, compulsory l"
        + "icense fees, residuals or any other payments;\n"
        + "\n"
        + "          ii. The Work does not infringe the copyright, trademark, publicity rig"
        + "hts, common law rights or any other right of any third party or constitute defam"
        + "ation, invasion of privacy or other tortious injury to any third party.\n"
        + "\n"
        + "     b. EXCEPT AS EXPRESSLY STATED IN THIS LICENSE OR OTHERWISE AGREED IN WRITIN"
        + "G OR REQUIRED BY APPLICABLE LAW, THE WORK IS LICENSED ON AN \"AS IS\" BASIS, WITHO"
        + "UT WARRANTIES OF ANY KIND, EITHER EXPRESS OR IMPLIED INCLUDING, WITHOUT LIMITATI"
        + "ON, ANY WARRANTIES REGARDING THE CONTENTS OR ACCURACY OF THE WORK.\n"
        + "\n"
        + "6. Limitation on Liability. EXCEPT TO THE EXTENT REQUIRED BY APPLICABLE LAW, AND"
        + " EXCEPT FOR DAMAGES ARISING FROM LIABILITY TO A THIRD PARTY RESULTING FROM BREAC"
        + "H OF THE WARRANTIES IN SECTION 5, IN NO EVENT WILL LICENSOR BE LIABLE TO YOU ON "
        + "ANY LEGAL THEORY FOR ANY SPECIAL, INCIDENTAL, CONSEQUENTIAL, PUNITIVE OR EXEMPLA"
        + "RY DAMAGES ARISING OUT OF THIS LICENSE OR THE USE OF THE WORK, EVEN IF LICENSOR "
        ...
        + "who have received Derivative Works or Collective Works from You under this Licen"
        + "se, however, will not have their licenses terminated provided such individuals o"
        + "r entities remain in full compliance with those licenses. Sections 1, 2, 5, 6, 7"
        ...
        + ", Licensor offers to the recipient a license to the original Work on the same te"
        + "rms and conditions as the license granted to You under this License.\n"
        + "\n"
