...
public class OSL_3_0 extends License{
   /**
    ...
    public String getTerms(){
        ...
        + " Works that You distribute or communicate shall be licensed under this Open Soft"
        + "ware License;\n"
        + "\n"
        ...
        + "\n"
        + "16) Modification of This License. This License is Copyright (c) 2005 Lawrence Ro"
        + "sen. Permission is granted to copy, distribute, or communicate this License with"
        + "out modification. Nothing in this License permits You to modify this License as "
        + "applied to the Original Work or to Derivative Works. However, You may modify the"
        + " text of this License and copy, distribute or communicate your modified version "
        + "(the \"Modified License\") and apply it to other original works of authorship subj"
        + "ect to the following conditions: (i) You may not indicate in any way that your M"
        + "odified License is the \"Open Software License\" or \"OSL\" and you may not use thos"
        + "e names in the name of your Modified License; (ii) You must replace the notice s"
        + "pecified in the first paragraph above with the notice \"Licensed under <insert yo"
        + "ur license name here>\" or with a notice of your own that is not confusingly simi"
        + "lar to the notice in this License; and (iii) You may not claim that your origina"
        + "l works are open source software unless your Modified License has been approved "
        + "by Open Source Initiative (OSI) and You comply with its license review and certi"
        + "fication process.\n"
; // the license text
    }
