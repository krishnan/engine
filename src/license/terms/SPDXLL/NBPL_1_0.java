...
public class NBPL_1_0 extends License{
   /**
    ...
    public String getTerms(){
        ...
        + "\n"
        + "Version 1, 22 August 1998 Copyright 1998, Net Boolean Incorporated, Redwood City"
        + ", California, USA All Rights Reserved.\n"
        + "\n"
        + "Note: This license is derived from the \"Artistic License\" as distributed with th"
        + "e Perl Programming Language. Its terms are different from those of the \"Artistic"
        + " License.\" \n"
        + "\n"
        + "PREAMBLE\n"
        + "\n"
        ...
        + "e subroutines and variables of the language defined by this Package shall not be"
        + " considered part of this Package, but are the equivalent of input as in Paragrap"
        + "h 6, provided these subroutines do not change the language in any way that would"
