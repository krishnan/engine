...
public class License {
    ...
    public static final File folder = new File("../src/license/terms");
    ...
    public void writeToDisk(File folder){
        File template = new File(folder, "LicenseTemplate.java");
        ...
        // adjust the package information
//        content = content.replace("package license;", "package license.terms.SPDXLL;");
